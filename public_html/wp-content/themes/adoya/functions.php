...
$GLOBALS['consulting_thinkup_theme_version'] = '1.0.8';
...
function consulting_thinkup_frontscripts() {
	...
	wp_enqueue_style('Roboto-font','https://fonts.googleapis.com/css?family=Roboto:400,500,700,900&amp;subset=cyrillic-ext,latin-ext' );
	wp_enqueue_style('bootstrap-style','https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css' );
	...
	wp_enqueue_script( 'bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js', array ('jquery'), '', true );
